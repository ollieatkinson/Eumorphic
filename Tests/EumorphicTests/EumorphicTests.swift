...
final class EumorphicTests: XCTestCase {
    ...
    func test_get_set() throws {
        ...
        XCTAssert(dictionary["string" as EumorphicPath] == "hello world")
        XCTAssert(dictionary["int" as EumorphicPath] == 1)

        XCTAssert(dictionary["structure", "is", "good", 0] == true)
        XCTAssert(dictionary["structure.is.good[0]" as EumorphicPath] == true)
